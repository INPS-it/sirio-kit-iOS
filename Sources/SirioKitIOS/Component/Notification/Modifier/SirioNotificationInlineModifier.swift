//
// SirioNotificationInlineModifier.swift
//
...
public struct SirioNotificationInlineModifier: ViewModifier {
    ...
    var life: SirioNotificationInlineModifier.Life?
...
public extension SirioNotificationInlineModifier {
    enum Direction {
        case top, bottom
