//
// SirioTableCellNumberOnly.swift
//
...
public struct SirioTableCellNumberOnly: View {
    ...
    HStack {
        VStack{
            ForEach(SirioTableSize.allCases, id: \.self) { size in
                SirioTableCellNumberOnly(size: size, text: "00")
            }
        }.padding()
        
        VStack{
            ForEach(SirioTableSize.allCases, id: \.self) { size in
                SirioTableCellNumberOnly(size: size, text: "00", scroll: true)
            }
        }.padding()
    }
}
